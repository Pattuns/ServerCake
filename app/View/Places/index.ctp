<div class="places index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('urn_id'); ?></th>
			<th><?php echo $this->Paginator->sort('station_id'); ?></th>
			<th><?php echo $this->Paginator->sort('sameAs'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($place['Place']['urn_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($place['Station']['title'], array('controller' => 'stations', 'action' => 'view', $place['Station']['id'])); ?>
		</td>
		<td><?php echo h($place['Place']['sameAs']); ?>&nbsp;</td>
		<td><?php echo h($place['Place']['lon']); ?>&nbsp;</td>
