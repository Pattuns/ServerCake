...
<?php echo $this->Form->create('Connect'); ?>
	<fieldset>
		<legend><?php echo __('Edit Connect'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Connect.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Connect.id'))); ?></li>
